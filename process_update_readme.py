...
def stream_and_extract_ancestries_from_url(xml_url, output_csv, output_excel, readme_path):
    ...
    if response.status_code == 200:
        ...
        with open(readme_path, 'a') as readme_file:
            readme_file.write(f"\n## Generated Files\n")
            readme_file.write(f"- Filtered Cell Lines CSV\n")
            readme_file.write(f"- Filtered Cell Lines Excel\n")
        
        print(f"README file updated with links to the generated files.")
